// Static attendees data
const staticAttendeesData = [
    { family: 'ANAK AT APO NI YOLLY', name: 'Shirly' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Rhapy' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Ashley' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Basty' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Jane' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Marc' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Lucy' },
    { family: 'ANAK AT APO NI YOLLY', name: 'Zoe' },
    { family: 'ANAK AT APO NI CORIT', name: 'Judith' },
    { family: 'ANAK AT APO NI CORIT', name: 'Timothy' },
    { family: 'ANAK AT APO NI DARDING', name: 'Beberly Alcantara' },
    { family: 'ANAK AT APO NI DARDING', name: 'Martin Alcantara' },
    { family: 'ANAK AT APO NI DARDING', name: 'Shaine Fadrilan' },
    ...
    { family: 'ANAK AT APO NI JUN', name: 'Franklin Eleccion' },
    { family: 'ANAK AT APO NI JUN', name: 'Charito Eleccion' },
    { family: 'ANAK AT APO NI JUN', name: 'Francis John Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Jonamine Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Juliet Faith Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Finella Jule Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Francess July Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Jonathan David' },
    { family: 'ANAK AT APO NI JUN', name: 'Christine Anne David' },
    { family: 'ANAK AT APO NI JUN', name: 'Princess Joanne David' },
    { family: 'ANAK AT APO NI JUN', name: 'Prince Christhan David' },
    { family: 'ANAK AT APO NI JUN', name: 'Prex Nathaniel David' },
    { family: 'ANAK AT APO NI JUN', name: 'Felix Fadrilan III' },
    { family: 'ANAK AT APO NI JUN', name: 'Gina Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Arabella Fadrilan' },
    { family: 'ANAK AT APO NI CORIT', name: 'Cherry Faz' },
    { family: 'ANAK AT APO NI CORIT', name: 'Samantha Faz' },
    { family: 'ANAK AT APO NI CORIT', name: 'Gian Morales' },
    { family: 'ANAK AT APO NI CORIT', name: 'Chester Morale' },
    { family: 'ANAK AT APO NI CORIT', name: 'Elora Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Ellie Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Magic Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Elaine Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Eric John Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Erika Mangao' },
    { family: 'ANAK AT APO NI CORIT', name: 'Marlon Fabalina' },
    { family: 'ANAK AT APO NI CORIT', name: 'Reshel Fabalina' },
    { family: 'ANAK AT APO NI CORIT', name: 'Annika Fabalina' },
    { family: 'ANAK AT APO NI CORIT', name: 'Aishel Fabalina' },
    { family: 'ANAK AT APO NI LIZA', name: 'Danny Sumayao' },
    { family: 'ANAK AT APO NI LIZA', name: 'Liza Sumayao' },
    { family: 'ANAK AT APO NI LIZA', name: 'Ian Tapuro' },
    { family: 'ANAK AT APO NI LIZA', name: 'May Tapuro' },
    { family: 'ANAK AT APO NI LIZA', name: 'Miguel Tapuro' },
    { family: 'ANAK AT APO NI LIZA', name: 'Rafael Tapuro' },
    { family: 'ANAK AT APO NI LIZA', name: 'Cholo Sabido' },
    { family: 'ANAK AT APO NI LIZA', name: 'Pangga Sabido' },
    { family: 'ANAK AT APO NI LIZA', name: 'Coco Sabido' },
    { family: 'ANAK AT APO NI LIZA', name: 'Tenten Sabido' },
    { family: 'ANAK AT APO NI LEONY', name: 'Chris Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Leony Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Yuan Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Elka Santos' },
    { family: 'ANAK AT APO NI LEONY', name: 'Ryan Santos' },
    { family: 'ANAK AT APO NI LEONY', name: 'Lia Santos' },
    { family: 'ANAK AT APO NI LEONY', name: 'Gab Santos' },
    { family: 'ANAK AT APO NI LEONY', name: 'Jericho Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Jean Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Jj Fiecas' },
    { family: 'ANAK AT APO NI LEONY', name: 'Debie Grefiel' },
    { family: 'ANAK AT APO NI LEONY', name: 'Glen Gualisa' },
    { family: 'ANAK AT APO NI LEONY', name: 'Demie Oliveron' },
    { family: 'ANAK AT APO NI MERLY', name: 'Adrian Fabula' },
    { family: 'ANAK AT APO NI MERLY', name: 'Cherry Fabula' },
    { family: 'ANAK AT APO NI MERLY', name: 'Andrea Chloe Fabula' },
    { family: 'ANAK AT APO NI JUN', name: 'Bong Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Gina Fadrilan' },
    { family: 'ANAK AT APO NI JUN', name: 'Bella Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Dwanie Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Lanie Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Nathaniel Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Sharon Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Rey Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Kevin Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Alex Padillo' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Bella Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Ace Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'JR Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Rose Gaba' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Joy Fadrilan' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Lan Joseph Fajardo' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Noreen De Jesus' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Babelin Fadrilan Roxas' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Alex Roxas' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Alexis Mae Roxas' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Aliana Faye Roxas' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Florian Fadrilan Fabito' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Philip Jeid Fabito' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Ann Toribio' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Jonathan Fiestada' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Zyra Fiestada' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Godwin Lorenz' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Lorelie Fadrilan Musa' },
    { family: 'ANAK AT APO NI TIBOY', name: 'Prince Danrie Musa' }
];
